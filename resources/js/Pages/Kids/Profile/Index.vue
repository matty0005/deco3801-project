<template>
    <layout class=" min-h-screen relative">
        ...
        <div class="relative transform translate-y-1/2 container m-auto flex flex-col h-full">
        <div class="h-96 mb-8">
            <div class="flex flex-row mb-8 ">
                ...
                <transition
                    ...
                    <div v-if="showName" class="self-end mx-auto cursor-pointer" @click="showNameEdit">
                ...
                <transition
                    ...
                    <div v-if="showAvatar" class="mx-auto cursor-pointer">
                        <form>
                            <label for="avtUpload">
                                <div class=" text-6xl font-bold mb-4 text-center">
                                    Avatar
                                </div>
                                <div class="rounded-full h-96 w-96 mx-auto cursor-pointer">
                                    <img class="h-96 w-96 mx-auto rounded-full" v-if="newAvatar == null" src="/images/kids/avatar_icon.png" />
                                    <img class="h-96 w-96 mx-auto rounded-full" v-else :src="newAvatar" />
                ...
                <transition
                    ...
                    <div v-if="showTheme" @click="showThemeEdit" class="mx-auto self-end cursor-pointer">
                        <div class=" text-5xl font-bold mb-4 text-center">
                            Theme
                        </div>
                        <div class="bg-yellow-200 rounded-full h-64 w-64 mx-auto">
