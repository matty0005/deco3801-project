<template>
    <layout class="min-h-screen">
        <div class="lg:min-h-kids min-h-screen relative flex flex-col justify-center">
            ...
            <div class="lg:h-96 mt-4 lg:mt-0 mb-2 lg:mb-8">
                <div class="flex flex-col mb-8 lg:mb-8 lg:flex-row ">
                    ...
                    <transition
                        ...
                        <div v-if="showName" class="mb-8 lg:mb-0 self-end mx-auto cursor-pointer" @click="showNameEdit">
                            <div class="text-5xl font-bold mb-4 text-center">
                                {{ childName !== '' ? (!showTheme && !showAvatar ? childName: 'Name'):'Name'}}
                            </div>
                            <div class="bg-yellow-200 rounded-full h-64 w-64 mx-auto">
                                    <img class="h-48 w-48 mx-auto pt-4" src="/images/kids/name_icon.png" />

                            </div>
                            <Textfield v-if="!showTheme && !showAvatar" label="Your name" v-model="childName"/>
                        </div>
                    </transition>
                    ...
                    <transition
                        ...
                        <div v-if="showAvatar" class="mb-8 lg:mb-0 mx-auto cursor-pointer">
                            <form>
                                <label for="avtUpload">
                                    <div class="text-5xl lg:text-6xl font-bold mb-4 text-center">
                                        Avatar
                                    </div>
                                    <div class="rounded-full h-64 w-64 lg:h-96 lg:w-96 mx-auto cursor-pointer">
                                        <img class="h-64 w-64 lg:h-96 lg:w-96 mx-auto rounded-full" v-if="newAvatar == null" src="/images/kids/avatar_icon.png" />
                                        <img class="h-64 w-64 lg:h-96 lg:w-96 mx-auto rounded-full" v-else :src="newAvatar" />
                    ...
                    <transition
                        ...
                        <div v-if="showTheme" @click="showThemeEdit" class="mb-8 lg:mb-0 mx-auto self-end cursor-pointer">
                            <div class=" text-5xl font-bold mb-4 text-center">
                                Theme
                            </div>
                            <div class="bg-yellow-200 rounded-full h-64 w-64 mx-auto">
            ...
            <div class="flex flex-row -mt-16 lg:mt-12 mb-4">
                <button @click="back" v-if="!showAvatar" class=" mt-16 text-2xl py-4 px-8  w-48 lg:w-1/4 mx-auto bg-orange-600 text-orange-100 rounded-full">
                    Back
                </button>
                <button  v-if="showAvatar" @click="onSubmit" class=" mt-16 text-2xl py-4 px-8 w-48 lg:w-1/4 mx-auto bg-orange-600 text-orange-100 rounded-full">
                    Save
                </button>
            </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            showThemeEdit() {
                if (!this.showAvatar && !this.showName && this.showTheme) {
                    return
                }
