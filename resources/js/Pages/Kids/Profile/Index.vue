    ...
    <layout class="bg-gray-100 min-h-screen relative">
        ...
        <div class="relative transform translate-y-1/2 container m-auto flex flex-row h-full">
                ...
                <div  class="mx-auto">
                    ...
                    <div class="bg-red-400 rounded-full h-96 w-96 mx-auto">
                    </div>
                </div>
