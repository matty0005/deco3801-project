    ...
    <layout class="bg-gray-100 min-h-screen">
        <div id="container" class="container mx-auto mt-8">
            <div class="flex flex-row">
                <div @click="changeColor('#000000')" class="bg-black h-8 w-8 mr-1 rounded"></div>
                <div @click="changeColor('#EF4444')" class="bg-red-500 h-8 w-8 mx-1 rounded"></div>
                <div @click="changeColor('#F97316')" class="bg-orange-500 h-8 w-8 mx-1 rounded"></div>
                <div @click="changeColor('#FACC15')" class="bg-yellow-400 h-8 w-8 mx-1 rounded"></div>
