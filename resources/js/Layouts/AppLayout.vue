    ...
    <div class="container mx-auto ">
      <div class="flex justify-between h-16">
        ...
        <div class="hidden sm:ml-6 sm:flex sm:items-center">
          <Link href="/switch/kids" method="post"  as="button" class="bg-parent-500 text-xs md:text-base text-white rounded-md py-1 sm:px-2 md:px-4 mx-2" role="menuitem" tabindex="-1" >Kid's Mode</Link>
