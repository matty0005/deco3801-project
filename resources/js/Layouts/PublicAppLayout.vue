<template>
  ...
  <div class="relative overflow-hidden">
    <header class="relative">
      <div class="bg-green-800 pt-6">
        <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
          <div class="flex items-center flex-1">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#">
                <span class="sr-only">Seedlings</span>
                <img class="h-8 w-auto sm:h-10" src="/images/logo_name_white_3.svg" alt="">
              </a>
              <div class="-mr-2 flex items-center md:hidden">
                <button type="button" class="bg-green-800 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-parent-800 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white" aria-expanded="false">
          ...
          <div v-if="$page.props.auth.user == null" class="hidden md:flex md:items-center md:space-x-6">
            <Link href="/login" class="text-base font-medium text-white hover:text-parent-200">
              Log in
            </Link>
            <Link href="/register" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-parent-600 hover:bg-parent-700">
              Sign up
            </Link>
          </div>
          <div v-else class="hidden md:flex md:items-center md:space-x-6">
            <Link href="/dashboard" class="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-parent-600 hover:bg-parent-700">
              Dashboard
            </Link>
          </div>
        </nav>
      ...
      <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top md:hidden">
        <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
          <div class="px-5 pt-4 flex items-center justify-between">
            <div>
              <img class="h-8 w-auto" src="/images/logo_name_white_3.svg" alt="">
            </div>
            <div class="-mr-2">
    ...
    <main>
      <div class="pt-6 bg-green-800  lg:overflow-hidden">
